...
const TheLoginDiv = ({ title, subtitle, children }) => {
  ...
  return (
   <div className='w-11/12 md:w-4/5 lg:w-3/5 mx-auto h-screen flex items-center justify-center'>
      <div className="w-full p-5 border border-silver rounded-xl text-center xl:w-1/2 xl:p-8">
         <h2 className="text-2xl lg:text-3xl font-bold leading-relaxed">{title}</h2>
         <p>{subtitle}</p>
         {children}
