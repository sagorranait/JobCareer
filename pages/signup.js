      ...
      <main>
         <TheLoginDiv title='Create an Account' subtitle='Even though registration just takes a few seconds.'>
            ...
            <ul class="grid w-full gap-6 md:grid-cols-2 pb-8">
               <li>
                  ...
                  <label for="client" class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-secondary peer-checked:text-primary">                           
                        <div class="block">
                           <div class="w-full text-base font-semibold">I’m a client, hiring for a project</div>
                        </div>
                  </label>
               </li>
               <li>
                  ...
                  <label for="freelancer" class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-secondary peer-checked:text-primary">
                        <div class="block">
                           <div class="w-full text-base font-semibold">I’m a freelancer, looking for work</div>
                        </div>
                  </label>
               </li>
            </ul>
            <div class="relative mb-5">
               ...
               <input type="text" id="email-address-icon" class="border border-silver text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-3" placeholder="Username"/>
            </div>
            <div class="relative mb-5">
               <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-gray-500 dark:text-gray-400">
               ...
               <input type="email" id="email-address-icon" class="border border-silver text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-3" placeholder="name@company.com"/>
            </div>
            <div class="relative mb-5">
               <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-gray-500 dark:text-gray-400">
               ...
               <input type="password" id="email-address-icon" class="border border-silver text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-3" placeholder="Password"/>
            </div>
